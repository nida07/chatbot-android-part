...
public class feedback extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url1 ="http://"+sh.getString("ip", "") + ":5000/viewfeed";
...
//                        Address.add(jo.getString("place")+ " \n "  + jo.getString("pin")+ " \n " +jo.getString("post"));
                    ...
                    l1.setAdapter(new Custom_viewfeed(feedback.this,complaints,date));
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (res.equalsIgnoreCase("valid")) {
                                    ...
                                    Toast.makeText(feedback.this, "Not Send!!", Toast.LENGTH_SHORT).show();
